  ...
  return (
    <div className="container mt-2">
      ...
      <div className="contanier-fluid text-center">
        <p>
          Konum bilgisine duyulan ihtiyacın artması ile Geomatik Mühendisliği’
          ne ilgi ve ihtiyaç da artmıştır. Geomatik Mühendisliği Nisan 2012’ de
          okulumuzda, Hacettepe Üniversitesinde açılmıştır. O zamandan bu yana
          mezunlarını vermekte olup, mezunlarımız pek çok başarıya da imza
          atmıştır. Topluluğumuz ise 2018-2019 güz döneminde kurulmuştur.
        </p>
        <p>
          Topluluk olarak hedefimiz kendine inanan, yaptığı işe güvenen,
          nitelikli olmak için çabalayan insanlarla birlikte yetişmek; öğrenmek
          ve gelişmektir. Bu hedefimize ulaşmak için emin adımlarla
          ilerlemekteyiz.
        </p>
        <p>
          Kendine güvenen, başarılı ve bilinçli insanları bünyesinde barındıran
          topluluğumuz için hedefimiz ve ona ulaşma serüvenimiz neden bu kadar
          önemli?
        </p>
        <p>
          Kendimizi hem kişisel hem de mesleki açıdan geliştirmeliyiz ki verimli
          sonuçlar alabilelim. Topluluğumuz da bu amaca hizmet etmek için var
          olmuştur. Hedefimize ulaşma serüvenimizde çizeceğimiz yollar, bu
          yollarda karşılaşacağımız engeller ve bu engelleri nasıl aşacağımız
          konuları hepimizi birbirine bağlamaktadır. Aramızda kurulan bu bağ
          bizim için çok kıymetlidir.
        </p>
        <p>
          Bizce, insanların kendilerini yalnızca akademik olarak geliştirmesi
          “nitelik” kavramına gölge düşürmektedir çünkü akademik başarı
          nitelikli bir insan olma yolunun yarısını oluşturmaktadır. Öyleyse
          diğer yarısı nedir? Nitelikli olma yolunda ilerlerken akademik
          başarının yanında yer alması gereken diğer özellikler de sosyal beceri
          ve saha tecrübesidir.
        </p>
      </div>
